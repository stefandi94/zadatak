...
SECRET_KEY = 'kd!n@7g1ozl2lu8eq)cd!qwb0mj^uzd$_3dg*k+$z5lknc-(=%'
...
BASE_APP_DIR = osp.join(BASE_DIR, 'app')

DATA_DIR = osp.join(BASE_APP_DIR, 'data')
MODEL_WEIGHTS_DIR = osp.join(BASE_APP_DIR, 'model_weights')
